...
iiwa_msgs::JointQuantity jointQuantityFromDouble(const double value) {
   ...
   */
  // iiwa_msgs::JointQuantity jointQuantityFromMultipleDouble(const double a1, const double a2, const double a3, const double a4, const double a5, const double a6, const double a7) {
  //   iiwa_msgs::JointQuantity quantity;
  //   quantity.a1 = a1;
  //   quantity.a2 = a2;
  //   quantity.a3 = a3;
